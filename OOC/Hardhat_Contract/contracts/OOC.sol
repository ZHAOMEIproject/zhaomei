...
contract OOC is ERC721A, Ownable, EIP712{
    ...
    struct setinfo{
        uint64 _total_supply;uint64 _fack_time;address _Receive;string _baseURL;
    ...
    //     uint256 _total_supply,uint256 _fack_time,address _Receive,string memory _baseURL,
