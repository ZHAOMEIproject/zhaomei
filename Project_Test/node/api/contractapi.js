...
// exports.contractapi = router.get("/test", async (req, res) => {
//     // let just = require("../test/test.json");
//     let just = await jsonFile.readFile("/root/learn/github/zhaomei/Project_Test/node/test/test.json");
//     res.send({
//         success:true,
//         data:{
//             result:just
